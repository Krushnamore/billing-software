    ...
    return (
      <div className="auth-card w-full max-w-md mx-auto">
        <div className="bg-card rounded-xl shadow-lg border border-border p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-2">{t('registerSuccessTitle')}</h2>
          <p className="text-muted-foreground text-sm mb-6">
            {t('registerSuccessSubtitle')}
          </p>
          <div className="bg-primary/5 border-2 border-primary/20 rounded-xl p-4 mb-6">
            <p className="text-xs text-muted-foreground mb-1">{t('uniqueVendorIdGenerated')}</p>
    ...
    <div className="auth-card w-full max-w-lg mx-auto">
      <div className="bg-card rounded-xl shadow-lg border border-border p-8">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-foreground">{t('registerHeader')}</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">{t('age')}</Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">{t('mobile')} *</Label>
          ...
          <div className="border-t border-border pt-4 mt-4">
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3">{t('shopDetailsHeading')}</p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">{t('shopName')} *</Label>
              <Input value={form.shopName} onChange={e => updateField('shopName', e.target.value)} placeholder="My Shop" className="h-10" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">{t('gstNo')}</Label>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-medium">{t('passwordConfirm')} *</Label>
